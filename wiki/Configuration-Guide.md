...
## Overview
This guide covers Configuration Guide for VMware VM DoD STIG Auditor.

## Prerequisites
- VMware vSphere environment
- PowerCLI installed
- Administrative access
- DoD STIG requirements knowledge

## Key Components
- STIG control validation
...
- [VMware Security Guide](https://docs.vmware.com/en/VMware-vSphere/8.0/vsphere-security/)
